...
public class Statistic extends javax.swing.JInternalFrame {
    ...
    private void chart() {
        charWeekPanel.removeAll();
        chartMonthPanel.removeAll();
        chartWeekBill.removeAll();
        chartMothBill.removeAll();
        chartWeekStatistic.removeAll();
        chartMonthStatistic.removeAll();
        //        biểu đồ tổng
        ...
        // biểu đồ tháng  đon nhập
        HistogramPanel panelmonthcoupon = new HistogramPanel();
        panelmonthcoupon.setHistogramHeight(300);
        panelmonthcoupon.setBarWidth(80);
        panelmonthcoupon.addHistogramColumn("Tháng 1", couponDaoImpl.totalMoneyBillMonth().get(0) / 0.05f, Color.RED);
        panelmonthcoupon.addHistogramColumn("Tháng 2", couponDaoImpl.totalMoneyBillMonth().get(1) / 0.05f, Color.BLUE);
        panelmonthcoupon.addHistogramColumn("Tháng 3", couponDaoImpl.totalMoneyBillMonth().get(2) / 0.05f, Color.ORANGE);
        panelmonthcoupon.addHistogramColumn("Tháng 4", couponDaoImpl.totalMoneyBillMonth().get(3) / 0.05f, Color.DARK_GRAY);
        panelmonthcoupon.addHistogramColumn("Tháng 5", couponDaoImpl.totalMoneyBillMonth().get(4) / 0.05f, Color.GREEN);
        panelmonthcoupon.addHistogramColumn("Tháng 6", couponDaoImpl.totalMoneyBillMonth().get(5) / 0.05f, Color.PINK);
        panelmonthcoupon.addHistogramColumn("Tháng 7", couponDaoImpl.totalMoneyBillMonth().get(6) / 0.05f, Color.LIGHT_GRAY);
        panelmonthcoupon.addHistogramColumn("Tháng 8", couponDaoImpl.totalMoneyBillMonth().get(7) / 0.05f, Color.YELLOW);
        panelmonthcoupon.addHistogramColumn("Tháng 9", couponDaoImpl.totalMoneyBillMonth().get(8) / 0.05f, Color.darkGray);
        panelmonthcoupon.addHistogramColumn("Tháng 10", couponDaoImpl.totalMoneyBillMonth().get(9) / 0.05f, Color.black);
        panelmonthcoupon.addHistogramColumn("Tháng 11", couponDaoImpl.totalMoneyBillMonth().get(10) / 0.05f, Color.GRAY);
        panelmonthcoupon.addHistogramColumn("Tháng 12", couponDaoImpl.totalMoneyBillMonth().get(11) / 0.05f, Color.blue);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jTabbedPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 848, Short.MAX_VALUE))
        );
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtTotalMoneyBill, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
        );
